# Generated by Django 3.1.4 on 2021-04-26 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('belongs_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.project')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('task_status', models.IntegerField(choices=[(1, 'Todo'), (2, 'In Progress'), (3, 'Review'), (4, 'Done')], default=1)),
                ('task_priority', models.IntegerField(choices=[(1, 'Low'), (2, 'Medium'), (3, 'High'), (4, 'Highest')], default=2)),
                ...
                ('sprint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.sprint')),
            ],
            options={
                'abstract': False,
            },
